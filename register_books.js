  ...
  function cadastro(llivros) {
    ...
    do{
      ...
      while(valor_correto==false){
        ...
        if (isNaN(preco)) {
          throw new Error("Preço inválido. Certifique-se de inserir um número válido.");
        }else{valor_correto=true}
      ...
      while(valor_correto==false){
        ...
        // Tenta converter a entrada do usuário em um número
            ...
            if (isNaN(Anop)) {
                throw new Error("Ano inválido. Certifique-se de inserir um número válido.");
            }else{valor_correto=true}
      ...
      while(valor_correto==false){
        try {
            ...
            if (isNaN(estoque)) {
                throw new Error("Valor para estoque inválido. Certifique-se de inserir um número válido.");
            }else{valor_correto=true}
